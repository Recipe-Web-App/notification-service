...
- **[Pre-commit Setup](../.pre-commit-setup.md)** - Development tools configuration
...
2. **Search first** - Check existing discussions and issues
3. **Provide context** - Include version, environment, and what you've tried
4. **Be specific** - Include error messages and steps to reproduce
